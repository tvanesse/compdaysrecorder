...
from . compdaysrecorderconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('compdaysrecorder')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('compdaysrecorder_lib')
